...
namespace dmRender
{
    ...
    void InitializeDebugRenderer(dmRender::HRenderContext render_context, uint32_t max_vertex_count, const void* vp_desc, uint32_t vp_desc_size, const void* fp_desc, uint32_t fp_desc_size)
    {
        ...
        HMaterial material3d = NewMaterial(render_context, vertex_program, fragment_program, 0, 0);
        ...
        HMaterial material2d = NewMaterial(render_context, vertex_program, fragment_program, 0, 0);
