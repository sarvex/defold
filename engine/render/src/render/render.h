...
namespace dmRender
{
    ...
    // Material
    HMaterial                       NewMaterial(dmRender::HRenderContext render_context, dmGraphics::HVertexProgram vertex_program, dmGraphics::HFragmentProgram fragment_program, dmGraphics::HTexture* textures, uint8_t texture_count);
